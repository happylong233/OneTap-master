...
data class Settings(
    ...
    val longPressAsClickEnabled: Boolean = true,
    val maximizeCallVolumeEnabled: Boolean = true,
    val hourlyTimeAnnouncementEnabled: Boolean = false,
    val hourlyTimeAnnouncementHours: Set<Int> = emptySet(),
    val password: String = "",
